...
//        }
        ...
        lstService.add(new Service("Home Tution", "Education", "Johar Town", R.drawable.ic_build_black_24dp));
        lstService.add(new Service("Car Wash", "Cleaning", "Muslim Town", R.drawable.ic_build_black_24dp));
        lstService.add(new Service("Dish Wash", "Cleaning", "Muslim Town", R.drawable.ic_build_black_24dp));
        lstService.add(new Service("Home Tution", "Education", "Johar Town", R.drawable.ic_build_black_24dp));
        lstService.add(new Service("Car Wash", "Cleaning", "Muslim Town", R.drawable.ic_build_black_24dp));
        lstService.add(new Service("Dish Wash", "Cleaning", "Muslim Town", R.drawable.ic_build_black_24dp));
        lstService.add(new Service("Home Tution", "Education", "Johar Town", R.drawable.ic_build_black_24dp));
