...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.MyViewHolder>{
    ...
    public SearchAdapter(Context mContext, ArrayList<ServiceQuote> mData) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v;
        v = LayoutInflater.from(mContext).inflate(R.layout.search_detail_recyclerview, parent, false);
